  ...
  try {
    ...
    switch (command) {
      case 'saveplugin': {
        ...
        await fs.writeFile(ruta, m.quoted.text);
        await m.react('✔️');
      ...
      case 'savefile': {
        ...
        await m.react('🕒');
        const path = `${text}.js`;
        await fs.writeFile(path, m.quoted.text);
        await m.react('✔️');
      ...
      case 'deletefile': {
        ...
        try {
          ...
          return conn.reply(m.chat, `ꕥ Archivo no encontrado.`, m);
        }
        await m.react('🕒');
      ...
      case 'getplugin': {
        ...
        await conn.sendMessage(m.chat, { document: fileContent, mimetype: 'application/javascript', fileName: `${text}.js` }, { quoted: m });
        await m.react('✔️');
        break;
      }
    }
