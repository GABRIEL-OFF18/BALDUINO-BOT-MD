...
if (global.db.data.users[who].warn === 0) throw `ꕥ El usuario tiene 0 advertencias.`
global.db.data.users[who].warn -= 1
await m.reply(`${global.db.data.users[who].warn === 1 ? `*@${who.split`@`[0]}*` : `❀ *@${who.split`@`[0]}*`} Se le quitó una advertencia.\n*ADVERTENCIAS ${global.db.data.users[who].warn}/3*`, null, { mentions: [who] })
break
}
case 'listadv': case 'advlist': {
const adv = Object.entries(global.db.data.users).filter(([_, u]) => u.warn)
const warns = global.db.data.users.warn || 0
